...
import type { Draft, JsonObject, ResolvedRef, Revision } from '@papermoon/story-storage'
export type { JsonObject, JsonValue, Project, ProjectId, Script, ScriptId, Draft, Revision, RevisionId, HistoryEntry, Publication, PublicationId, ContentRef, ResolvedRef } from '@papermoon/story-storage'
export const CONTENT_FORMAT = 'papermoon.story'
...
export interface StoryContent {
  ...
  readonly version: typeof CONTENT_VERSION
  readonly metadata: JsonObject
  readonly program: Program
  readonly texts: TextCatalog
}
export type StorySnapshot =
  | { readonly kind: 'draft'; readonly ref: Extract<ResolvedRef, { kind: 'draft' }>; readonly draft: Draft; readonly content: StoryContent }
  | { readonly kind: 'revision'; readonly ref: Extract<ResolvedRef, { kind: 'revision' }>; readonly revision: Revision; readonly content: StoryContent }
export type DraftSnapshot = Extract<StorySnapshot, { kind: 'draft' }>
export type RevisionSnapshot = Extract<StorySnapshot, { kind: 'revision' }>
...
export interface ContentSettings {
  readonly format: typeof CONTENT_FORMAT; readonly version: typeof CONTENT_VERSION
