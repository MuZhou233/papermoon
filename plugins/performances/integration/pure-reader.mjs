...
try {
  ...
  const artifact = createArtifact('0'.repeat(64), { entry: 'story.js', language: 'en', limits: { inputBytes: 1, modules: 1, outputBytes: 1000, executionMs: 1, totalMs: 1, concurrency: 1, memoryMb: 1 } }, { context: { systemPrompt: 'Frozen', messages: [] }, state: { initial: {}, schema: { type: 'object' } }, functions: [], program: { files: { 'story.js': '' }, texts: {} } })
