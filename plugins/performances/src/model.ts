...
const frozenSchema = z.strictObject({ version: z.literal(1), originSessionId: identity, scriptId: identity, revisionId: identity, ordinal: z.number().int().positive(), scriptName: z.string(), projectName: z.string(), description: z.string(), attachmentKey: identity, artifact: z.unknown(), checksum: z.string().regex(/^[a-f0-9]{64}$/) })
