...
import type { ContentOperation, PlaybookContent, RestoreSelection, TextEntry } from './model.ts'
...
export function applyOperations(content: PlaybookContent, operations: readonly ContentOperation[]): PlaybookContent {
...
export function restoreContent(target: PlaybookContent, source: PlaybookContent, selection: RestoreSelection): PlaybookContent {
