...
import type { StoryContent, ProgramFile, TextEntry } from '@papermoon/story-core'
...
function value(content: StoryContent, target: Target): unknown {
  switch (target.kind) {
...
export class StoryObservations {
