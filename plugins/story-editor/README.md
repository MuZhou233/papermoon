...
The editor adds a script overview and independent detail pages to PaperMoon. It calls the [logic core](../story-core/README.md) through authenticated DSH requests. It creates no agent sessions and performs no compilation, publication, approval or model calls.
