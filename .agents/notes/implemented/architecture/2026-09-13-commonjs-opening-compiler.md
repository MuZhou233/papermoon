...
Explicit editor and tool compilation share the service. The editor initializes saved artifacts for its preview and marks results from changed inputs as stale. Tool compilation leaves observation rights unchanged. No publication or approval condition is added. The [manual-editor decision](2026-09-12-manual-playbook-editor.md) continues to own editing and local buffers.
