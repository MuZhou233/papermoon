...
Main tests cover compilation, simulation, invocation, persistence failure, receipt recovery and Fork. Real DSH and browser checks cover native declarations, original results, complete requests and readonly inspection. These checks establish engineering readiness; authored playbooks and interaction quality still need experience feedback.
